...
def main(class_parents, class_parents_idx, seed,
    ...
    train_data_path = f"{dataset_path}/{task}_TrainUpsampledPatient.npz"
    ...
    test_data_path = f"{dataset_path}/{task}_TestUpsampledPatient.npz"

    test_data = np.load(test_data_path)['data_obs']


    val_data_path = f"{dataset_path}/{task}_ValUpsampledPatient.npz"
