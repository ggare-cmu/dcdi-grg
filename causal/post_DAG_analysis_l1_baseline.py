...
import causal.classifier_on_causal_parents_heart_disease_exp_l1_baseline as classifier
...
if __name__ == "__main__":
    ...
    exp_pth = f"/home/grg/Research/dcdi-grg/exp/{exp_trial}{interv_type}_TrainUpsampledPatient_l1_classifier"
    ...
    task = '-'.join(i_dataset[2:].split('_')[0].split('-')[:-1]) + "_l1_classifier"
